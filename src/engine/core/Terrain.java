...
public class Terrain {
	...
	public Terrain(int gridX, int gridZ, GLLoader openGLLoader, TerrainTexturePack texturePack, TerrainTexture blendMap, String heightMap, List<WaterTile> waterTiles) {
		...
		this.x = gridX * SIZE;
		this.z = gridZ * SIZE;
		heightMap = gridX + "-" + gridZ + "/" + heightMap;
		this.model = generateTerrain(openGLLoader, heightMap);
	...
	private RawModel generateTerrain(GLLoader openGLLoader, String heightMap) {
		...
		return openGLLoader.loadToVAO(vertices, textureCoords, normals, indices);
	}
