...
public class EntityRenderer {
	...
	public EntityRenderer(StaticShader shader, Matrix4f projectionMatrix, Frustum frustum) {
		this.shader = shader;
    	...
    	for(ModelSystem model: entities.keySet()) {
    		...
    		for(Entity entity:batch) {
				...
				if (distance > 0) {
					...
					GL11.glDrawElements(GL11.GL_TRIANGLES, model.getModel(0).getVertexCount(), GL11.GL_UNSIGNED_INT, 0);
				}
    		}
			unbindStaticModel();
    	}
